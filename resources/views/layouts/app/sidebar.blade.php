...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Bandeja de entrada')" class="grid">
                    <flux:sidebar.item icon="home" :href="route('dashboard')" :current="request()->routeIs('dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </flux:sidebar.item>

                    @can('bandeja.ver')
                        <flux:sidebar.item icon="inbox" :href="route('bandeja.inbox')" :current="request()->routeIs('bandeja.*')" wire:navigate>
                ...
                @can('expedientes.ver')
                    <flux:sidebar.group :heading="__('Expedientes')" class="grid">
                ...
                @can('contactos.ver')
                    <flux:sidebar.group :heading="__('Contactos')" class="grid">
